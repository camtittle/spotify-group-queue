...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.Party", b =>
                {
                    b.OwnsOne("api.Models.Track", "CurrentTrack", b1 =>
                        {
                            ...
                            b1.HasOne("api.Models.Party")
                                .WithOne("CurrentTrack")
                                .HasForeignKey("api.Models.Track", "PartyId")
            ...
            modelBuilder.Entity("api.Models.User", b =>
                {
                    ...
                    b.OwnsOne("api.Models.SpotifyDevice", "CurrentDevice", b1 =>
                        {
                            ...
                            b1.HasOne("api.Models.User")
                                .WithOne("CurrentDevice")
                                .HasForeignKey("api.Models.SpotifyDevice", "UserId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
